...
ENCHA_REF="${ENCHA_REF:-v0.2.3}"                     # tag fixa
ENCHA_TARBALL_SHA256="${ENCHA_TARBALL_SHA256:-576f4998366b85c0ca5769890eee7be23f64409ae7d32cbdf14d12f4ca9c4244}"     # SHA-256 do tarball (v0.2.3)
