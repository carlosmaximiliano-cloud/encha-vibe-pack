...
ENCHA_REF="${ENCHA_REF:-v0.1.0}"                     # tag fixa
ENCHA_TARBALL_SHA256="${ENCHA_TARBALL_SHA256:-3f158a954b6ce3f08e71d51775f5841ad8eab1ad77682075599909a52784e7eb}"     # SHA-256 do tarball (v0.1.0)
