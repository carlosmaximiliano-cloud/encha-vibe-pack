...
```bash
curl -fsSL https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.8/install.sh | bash
```
...
irm https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.8/install.ps1 -OutFile $f
...
- **Baixe e inspecione antes de rodar** (recomendado). Em vez do `| bash`, baixe e leia:
  ```bash
  curl -fsSL https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.8/install.sh -o install.sh
