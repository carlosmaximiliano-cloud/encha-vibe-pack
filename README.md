...
```bash
curl -fsSL https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.1/install.sh | bash
```
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.1/install.ps1))) -Mode wsl
```
...
- **Baixe e inspecione antes de rodar** (recomendado). Em vez do `| bash`, baixe e leia:
  ```bash
  curl -fsSL https://raw.githubusercontent.com/carlosmaximiliano-cloud/encha-vibe-pack/v0.2.1/install.sh -o install.sh
